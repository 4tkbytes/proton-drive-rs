...
pub mod raw {
    ...
    pub fn drive_client_create(
        ...
        unsafe {
            ...
            let create_client_fn: libloading::Symbol<unsafe extern "C" fn(
                isize,
                isize,
                ByteArray,
                *mut isize,
            ) -> i32> = sdk.sdk_library.get(b"drive_client_create")?;
    ...
    pub fn drive_client_register_node_keys(
        ...
        unsafe {
            ...
            let register_keys_fn: libloading::Symbol<unsafe extern "C" fn(
                isize,
                ByteArray,
            ) -> i32> = sdk.sdk_library.get(b"drive_client_register_node_keys")?;
    ...
    pub fn drive_client_register_share_key(
        ...
        unsafe {
            ...
            let register_key_fn: libloading::Symbol<unsafe extern "C" fn(
                isize,
                ByteArray,
            ) -> i32> = sdk.sdk_library.get(b"drive_client_register_share_key")?;
